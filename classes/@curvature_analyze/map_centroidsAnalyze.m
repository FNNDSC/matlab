function [C, a_status] = map_centoidsAnalyze(C)
%
% NAME
%
%  function [a_status] = map_centroidsAnalyze(C)
%
% ARGUMENTS
% INPUT
...
C.mstack_proc 	                = push(C.mstack_proc, 'map_centroidsAnalyze');

[C, adata, a_status]            = map_processSubj(C, @mapindex_centroidsAnalyze);
