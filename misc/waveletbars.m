function [acell_table, acell_hist] = waveletbars(varargin)
%
% NAME
%
%	function [acell_table, acell_hist] = waveletbars(	[astr_hemi,
%								ab_sulcCurv,
%								ac_plotArgs,
%								astr_title,
%								astr_xlabel])
...
%
%	Since its original conception, it has evolved somewhat into a
%	convenient "meta" curature analysis tool, providing (lzg) data
%	as well as other statistical information. This has resulted in
%	more elaborate function arguments in an effort to better control
%	all the additional functionality. In fact, this function will
%	work on any curvature files and is not specific to wavelet curvatures.
%
% PRECONDITIONS
%
