function [void] = speedComp(a_trials, a_size)
% 
% SYNOPSIS
%  	[void] = speedComp(a_trials, a_size)
% 
% ARGS
...
disp('**********')
txt = sprintf('Mean of M_A:\t\t\t%f', mean2(M_A)); disp(txt)
txt = sprintf('Standard deviation of M_A:\t%f', std2(M_A)); disp(txt)

disp('**********')
txt = sprintf('Mean of M_B:\t\t\t%f', mean2(M_B)); disp(txt)
txt = sprintf('Standard deviation of M_B:\t%f', std2(M_B)); disp(txt)

disp('**********')
txt = sprintf('Mean of M_C:\t\t\t%f', mean2(M_C)); disp(txt)
txt = sprintf('Standard deviation of M_C:\t%f', std2(M_C)); disp(txt)
