...
%%	the slopes (m) and intercepts (b) for all lines from the first 
%%	X,Y point to each subsequent point are determined and averaged.
%%
%% PRECONDITIONS
%%
